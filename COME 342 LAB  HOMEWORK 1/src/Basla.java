...
public class Basla {
	...
	public static void main(String[] args) {
		...
		System.out.println("(add new client)-(get all clients)");   //bu seçeneklerden birini yazýp istediðimiz kaddr add client yapýp daha sonra get all clients diyerek bütün eklenenlerin bilgilerine ulaþabliyoruz
		while(true)
		{
